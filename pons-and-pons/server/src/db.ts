...
const setupDb = async () => {
    ...
    await db.none(`INSERT INTO product_category (category_name) VALUES ('sugar');`);
    await db.none(`INSERT INTO product_category (category_name) VALUES ('sugar-free');`);

    // Inserting some sugar dummy products
    await db.none(`INSERT INTO product (name, image, slider_images, description, category_id, tags) 
        VALUES ('coffee', 
                'sugar-cafe.png',
